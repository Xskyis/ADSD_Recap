        ...
        do {
            ...
            switch (pilih) {
                ...
                case 3:
                    ...
                    if (lihat != null) {
                        System.out.println("Tugas terakhir dikupulkan oleh : " + lihat.nama);
                    }
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    Mahasiswa03 mhsBawah = stack.peekBottom();
                    if (mhsBawah != null) {
                        System.out.println("Tugas terbawah:");
                        System.out.println(mhsBawah.nama + "\t" + mhsBawah.nim + "\t" + mhsBawah.kelas);
                    }
                    break;
                case 6:
